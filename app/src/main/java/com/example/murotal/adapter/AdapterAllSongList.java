...
public class AdapterAllSongList extends RecyclerView.Adapter {
    ...
    public AdapterAllSongList(ArrayList<ItemSong> arrayList) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            Picasso.get()
                    ...
                    .placeholder(R.mipmap.placeholder_song)
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.popup_add_queue:
                        ...
                        GlobalBus.getBus().postSticky(new supriyanto.ownmodal.ItemMyPlayList("","",null));
                        break;
