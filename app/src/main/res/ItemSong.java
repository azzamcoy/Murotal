...
public class ItemSong extends com.example.murotal.ownmodal.ItemSong implements Serializable {

	private String id, catId, catName, artist, url, imageBig, imageSmall, title, duration, description, totalRate, averageRating="0", views, downloads, userRating="";
